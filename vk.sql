...
>>>>>>> b785d08839ab23b8d105721d8897d1fbdd19127b
CREATE TABLE users (
...
INSERT `users`(firstname, lastname, email, password_hash, phone, is_deleted) VALUES ('Роман', 'Гараев', 'roma@ebmail.top', '0#2at3#3sj%15#4fs', 89534568038, 0);
INSERT `users`(firstname, lastname, email, password_hash, phone, is_deleted) VALUES ('Вовчик', 'Барисов', 'baris@ebmail.top', '0#2am3#3sw%it5#4ff', 89234528677, 0);
SELECT * FROM  `users`;
...
INSERT `photo_albums`(name, user_id) VALUES ('Коммандировка', 2);
...
INSERT `profiles`(gender, birthday, photo_id, created_at, hometown) VALUES ('m', '1993-02-04', 1, '2012-12-01 22:54:53', 'kazan');
INSERT `profiles`(gender, birthday, photo_id, created_at, hometown) VALUES ('m', '1990-12-09', 2, '2010-02-13 13:23:04', 'moscov');
